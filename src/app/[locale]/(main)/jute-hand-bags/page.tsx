            ...
            <section className="bg-white py-24 sm:py-32">
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="mx-auto max-w-2xl text-center mb-16">
                        ...
                        <p className="text-lg text-gray-600">{t('findPerfect')}</p>
                    </div>
                        ...
                        {categories.map((cat, i) => (
                            ...
                            >
                                ...
                                <div className="absolute inset-0 flex flex-col justify-end p-6 text-white">
                                    <p className="text-xs uppercase tracking-widest text-white/70 mb-1">{t('productsCount', { count: cat.count })}</p>
                                    ...
                                    <div className="mt-3 flex items-center gap-1 text-sm font-medium opacity-0 group-hover:opacity-100 translate-y-2 group-hover:translate-y-0 transition-all duration-300">
                                        {t('explore')} <ArrowRightIcon className="w-4 h-4" />
                                    </div>
                                </div>
                            </Link>
                        ))}
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
                        ...
                        <article className="group bg-white rounded-2xl p-10 text-center shadow-sm hover:shadow-xl transition-all duration-500 hover:-translate-y-2 border border-transparent hover:border-green-100">
                            ...
                            <h3 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-green-700 transition-colors duration-300">{t('ecoFriendly')}</h3>
                        ...
                        <article className="group bg-white rounded-2xl p-10 text-center shadow-sm hover:shadow-xl transition-all duration-500 hover:-translate-y-2 border border-transparent hover:border-amber-100">
                            ...
                            <h3 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-amber-700 transition-colors duration-300">{t('handcraftedInRajasthan')}</h3>
                            <p className="text-gray-600 leading-relaxed">
                        ...
                        <article className="group bg-white rounded-2xl p-10 text-center shadow-sm hover:shadow-xl transition-all duration-500 hover:-translate-y-2 border border-transparent hover:border-blue-100">
                            ...
                            <h3 className="text-xl font-bold text-gray-900 mb-3 group-hover:text-blue-700 transition-colors duration-300">{t('premiumDurability')}</h3>
                            <p className="text-gray-600 leading-relaxed">
                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 lg:gap-12">
                        <div className="group flex items-center gap-5 justify-center sm:justify-start">
                            ...
                            <div>
                                <h4 className="font-bold text-gray-900">{t('freeWorldwideShipping')}</h4>
                                <p className="text-sm text-gray-500">{t('onAllOrders')}</p>
                            </div>
                        </div>
                        <div className="group flex items-center gap-5 justify-center">
                            ...
                            <div>
                                <h4 className="font-bold text-gray-900">{t('easyReturns')}</h4>
                                <p className="text-sm text-gray-500">{t('noQuestionsAsked')}</p>
                            </div>
                        </div>
                        <div className="group flex items-center gap-5 justify-center sm:justify-end">
                            ...
                            <div>
                                <h4 className="font-bold text-gray-900">{t('secureCheckout')}</h4>
                                <p className="text-sm text-gray-500">{t('sslEncrypted')}</p>
                            </div>
                        </div>
                    </div>
                </div>
