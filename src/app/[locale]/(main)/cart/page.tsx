                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
                    ...
                    {cart && cart.length > 0 && (
                        <div className="badge badge-primary badge-lg gap-2">
                            {cart.length} {cart.length === 1 ? tCommon('item') : tCommon('items')}
                        </div>
                    )}
                </div>
                ...
                {cart && cart.length > 0 && (
                    <div className="mt-12 grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div className="flex items-center gap-3 p-4 bg-base-100 rounded-xl border border-base-300/50">
                            ...
                            <div>
                                <p className="text-sm font-medium text-base-content">{t('secureCheckout')}</p>
                                <p className="text-xs text-base-content/60">{t('sslEncrypted')}</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-3 p-4 bg-base-100 rounded-xl border border-base-300/50">
                            ...
                            <div>
                                <p className="text-sm font-medium text-base-content">{t('freeShipping')}</p>
                                <p className="text-xs text-base-content/60">{t('freeShippingMin')}</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-3 p-4 bg-base-100 rounded-xl border border-base-300/50">
                            ...
                            <div>
                                <p className="text-sm font-medium text-base-content">{t('easyReturns')}</p>
                                <p className="text-xs text-base-content/60">{t('returnPolicy')}</p>
                            </div>
                        </div>
                        <div className="flex items-center gap-3 p-4 bg-base-100 rounded-xl border border-base-300/50">
                            ...
                            <div>
                                <p className="text-sm font-medium text-base-content">{t('support247')}</p>
                                <p className="text-xs text-base-content/60">{t('dedicatedHelp')}</p>
                            </div>
                        </div>
                    </div>
                )}
