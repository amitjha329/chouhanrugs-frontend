...
export default function CategoryProductListingContainer({
    products,
    facets,
    facetsStats,
    totalHits,
    ...
    facetsStats: Record<string, { min: number; max: number }>
    totalHits: number
    totalPages: number
    currentPage: number
...
function PriceRangeSlider({
    ...
    const stats = facetsStats.productSellingPrice || { min: 0, max: 1000 }
