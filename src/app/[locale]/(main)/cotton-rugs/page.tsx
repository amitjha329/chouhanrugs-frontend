                ...
                <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
                    <div className="text-center">
                        ...
                        <div className="mt-6 text-lg leading-8 text-gray-600">
                            The process of <Link href="/cotton-rugs"><span className='font-semibold text-gray-900 underline'>hand crafting cotton rugs</span></Link> at Chouhan Rugs begins with the careful selection of high-quality cotton fibers. Chouhan Rugs takes immense pride in using only the finest cotton, renowned for its softness, durability, and natural charm. As an environmentally conscious choice, cotton aligns with the values of customers who prioritize sustainability. To ensure the cotton meets the strictest standards for quality and purity, it is meticulously sourced. By procuring top-tier cotton directly from the mills, Chouhan Rugs guarantees the highest level of quality.
                        </div>
                ...
                <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
                    <div className="lg:col-span-2 lg:col-start-2 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl text-end lg:gap-x-8 lg:px-8">
                        <div className="lg:pl-4">
                            <div className="lg:max-w-lg">
                                <p className="text-base font-semibold leading-7 text-primary">Process of</p>
                                <h2 className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">Manufacturing of Cotton Rugs</h2>
                                {/* <div>
                            ...
                            <div className="max-w-xl text-base leading-7 text-gray-700 lg:max-w-lg">
                                <ul role="list" className="space-y-8 text-gray-600">
                                    ...
                                    <li className="flex gap-x-3">
                                        {/* <ServerIcon className="mt-1 h-5 w-5 flex-none text-indigo-600" aria-hidden="true" /> */}
                                        <span>
                                            <strong className="font-semibold text-gray-900">Weaving:</strong> The weaving process involves the intricate task of intertwining cotton threads to form the rug&apos;s design. This complex stage requires not only technical expertise but also a discerning eye for detail. The weavers must carefully manipulate the threads on the loom, creating a harmonious interplay of colors and patterns that bring the design to life. Each movement of the weaver&apos;s hands, each thread that is added, contributes to the overall beauty and uniqueness of the rug. This process is a testament to the weaver&apos;s skill and artistry, transforming simple cotton threads into a stunning piece of decor for our clinet to <Link href="/cotton-rugs"><span className='font-semibold text-gray-900 underline'>buy premium quality and branded cotton rugs online</span></Link>.
                                        </span>
                                    </li>
                                    <li className="flex gap-x-3">
                                        {/* <ServerIcon className="mt-1 h-5 w-5 flex-none text-indigo-600" aria-hidden="true" /> */}
