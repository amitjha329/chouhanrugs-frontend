...
import FormattedAddress from '@/ui/frontend/FormattedAddress'
import ContactUsSideVector from '@/ui/frontend/Vectors/ContactUsSideVector'
    ...
    return (<>
        ...
        <div className="max-w-screen-xl my-14 grid gap-8 grid-cols-1 md:grid-cols-2 py-16 mx-auto bg-gray-100 text-gray-900 rounded-lg shadow-lg mb-60 max-sm:mb-40">
            ...
            <div className="pr-8 pl-8 md:pl-0 md:pr-12 lg:pr-16 xl:pr-32">
                ...
                <div className="mt-8">
                    <button className="btn uppercase text-sm font-bold tracking-wide bg-indigo-500 text-gray-100 p-3 rounded-lg w-full focus:outline-none focus:shadow-outline">
                        Send Message
                    </button>
                </div>
            </div>
