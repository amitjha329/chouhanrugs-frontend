type NotificationTypes = "info" | "error" | "warning" | "success"
/**
 * Sending On Page Notification in entire project.
 * The Project Wrapper Must Include a div container with class "notification" for this to work. 
 * @param {NotificationTypes} type Type of Notification, can only be 'info'|'error'|'warning'|'success'
 * @param {string} text Notification Message.
 */

const onPageNotifications = (type: NotificationTypes, text: string): Promise<void> => {
...
export default onPageNotifications;