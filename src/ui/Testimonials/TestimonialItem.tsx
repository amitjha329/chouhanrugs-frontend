...
const TestimonialItem = async (props: TestimonialDataModel) => {
        ...
        <div className='flex flex-col break-inside-avoid-column max-md:carousel-item max-md:w-full'>
            ...
            <div className='flex justify-between items-center gap-5'>
                ...
                <div className='flex-grow flex flex-col'>
                    ...
                    <div className='text-xs text-gray-600 flex items-center'><Image src={verified} alt="verified" />{t('verifiedBuyer')}</div>
                </div>
            </div>
        </div>
    )
