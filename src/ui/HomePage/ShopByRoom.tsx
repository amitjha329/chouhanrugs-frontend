            ...
            <div className='fluid_container'>
                ...
                <div className="grid grid-cols-2 max-md:grid-cols-1 gap-12">
                    <div className="flex items-start">
                        ...
                        <div className="ml-6">
                            <h2 className="~text-lg/xl">Entry way/Hall Way</h2>
                    ...
                    <div className="flex items-start">
                        ...
                        <div className="ml-6">
                            <h2 className="~text-lg/xl">Bed Room</h2>
                            <p className="mt-2 text-neutral-700 font-light text-sm">
                    ...
                    <div className="flex items-start">
                        ...
                        <div className="ml-6">
                            <h2 className="~text-lg/xl">Dining Room</h2>
                            <p className="mt-2 text-neutral-700 font-light text-sm">
                    ...
                    <div className="flex items-start">
                        ...
                        <div className="ml-6">
                            <h2 className="~text-lg/xl">Living Room</h2>
                            <p className="mt-2 text-neutral-700 font-light text-sm">
