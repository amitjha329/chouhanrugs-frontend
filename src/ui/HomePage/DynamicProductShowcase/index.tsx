...
/* ------------------------------------------------------------------ */
/*  Mini Product Card (reused layout identical to JuteHandBagsShowcase) */
/* ------------------------------------------------------------------ */
...
const DynamicProductShowcase = async () => {
    const showcaseData = await getHomePageProductShowcase()
