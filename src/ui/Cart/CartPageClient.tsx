    ...
    return (
        <main className="min-h-screen bg-[#fbfaf7]">
            <div className="fluid_container mx-auto px-4 py-5 md:px-0 md:py-8">
                ...
                {activeCart.length > 0 ? (
                    <div className="grid gap-5 lg:grid-cols-[minmax(0,1fr)_360px] xl:grid-cols-[minmax(0,1fr)_390px]">
                    ...
                    <section className="flex min-h-[420px] flex-col items-center justify-center rounded-lg border border-primary/10 bg-base-100 px-4 text-center">
