...
const GuestCartItemClient = ({ item, userCurrency, onQuantityChange, onRemove }: {
    ...
    const pName = resolveLocalizedString(item.cartProduct[0]?.productName, locale) || resolveLocalizedString(item.cartProduct[0]?.productTitle, locale) || 'Product'
            ...
            <div className="flex flex-col flex-1 min-w-0 justify-between mt-2 sm:mt-0 sm:pl-2 md:pl-4">
                ...
                <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-2 mt-3">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="px-3 py-1 text-base font-medium bg-base-100 border border-base-300 rounded min-w-[2.5rem] text-center">{item.quantity}</span>
