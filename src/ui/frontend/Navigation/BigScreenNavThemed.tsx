...
const BigScreenNavThemed = ({ categoriesData, siteData, festive, algoliaIndex, queryIndexName }: { siteData: SiteDataModel, categoriesData: Array<CategoriesDataModel>, festive: null | "christmas" | "newyear", algoliaIndex: string, queryIndexName: string }) => {
    const router = useRouter()
    const { cartCount } = useDataConnectionContext()
    const { data: session } = useSession()
    const { userLocation } = useLocationContext()
    const [activeCategory, setActiveCategory] = useState(categoriesData[0]._id)
    ...
    return (
        <div className="hidden md:block bg-white">
            ...
            <div className="border py-3 px-6 relative">
                {
                    festive == "christmas" && <Image src="/nav_christmas.png" fill alt="Themed BG" className="pointer-events-none z-10" />
                }
                {
                    festive == "newyear" && <Image src="/nav_newyear.png" fill alt="Themed BG" className="pointer-events-none z-10" />
                }
                    ...
                    <div className="flex justify-between">
                        ...
                        <div className="flex flex-1 gap-x-3">
                                ...
                                {({ open }: { open: boolean }) => (
                                    <>
                                        ...
                                        <Transition
                                            ...
                                            <Popover.Panel as="div" className="bg-white fixed z-10 left-0 mt-16 w-full max-w-[100vw] transform px-4 sm:px-0 mega-menu border-t border-primary rounded-none shadow-lg">
                            ...
                            <div className="relative w-full">
                                ...
                                }} detachedMediaQuery="none" openOnFocus onSubmit={(_: any) => {
...
export default BigScreenNavThemed