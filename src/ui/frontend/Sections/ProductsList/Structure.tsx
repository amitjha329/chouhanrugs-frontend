...
const StructureListing = ({ children }: {
    ...
    return (
        <>
            ...
            <div className="container flex flex-row mx-auto py-10 px-10 sm:px-0 gap-x-4 no-scrollbar items-start">
                <StickyBox offsetTop={202} offsetBottom={0} className="basis-1/6 hidden lg:block flex-grow-0">
            ...
            <FilterBottomSheet filterSheetOpen={filterSheetOpen} toggleOpenCallback={filterBottomSheetToggle} />
        </>
    )
}
