...
import { savePoliciesContent } from "@/lib/actions/savePoliciesData";
import onPageNotifications from "@/ui/common/onPageNotifications";
import { Editor } from "@tinymce/tinymce-react";
import { useRef, useState } from "react";
import TINY_MCE_KEY from "../../../../tinymce.config";

const PolicyContentForm = ({ content }: { content: string }) => {
        ...
        <div className='form-control gap-4'>
            ...
            <div className='card-actions justify-end'>
                <button className='btn btn-primary' type='submit' onClick={e => {
                    savePoliciesContent(editorRef.current.getContent()).then((result) => {
                        if (result.ack) {
